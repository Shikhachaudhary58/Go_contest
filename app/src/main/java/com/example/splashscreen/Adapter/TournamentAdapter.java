...
import com.example.splashscreen.Tournament_detail;

import java.util.List;

public class TournamentAdapter extends RecyclerView.Adapter<TournamentAdapter.tournamentadapter>{
    private List<Data> list;

    public TournamentAdapter(List<Data> list) {
        this.list = list;
    }

    @NonNull
    @Override
    public tournamentadapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new tournamentadapter(LayoutInflater.from(parent.getContext()).inflate(R.layout.items,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull tournamentadapter holder, int position) {
        ...
        holder.joinnow.setOnClickListener(view -> {
            ...
            Intent intent = new Intent(context, Tournament_detail.class); // Replace ContestDetailsActivity with the desired activity
    ...
    public static class tournamentadapter extends RecyclerView.ViewHolder{
        ImageView imageview;
        TextView textques;
        TextView textplay;
        TextView textfees;
        ...
        public tournamentadapter(@NonNull View itemView) {
            super(itemView);
